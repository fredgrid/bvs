...
FC_REFLECT(bvsio::chain::permission_level_weight, (permission)(weight) )
FC_REFLECT(bvsio::chain::key_weight, (key)(weight) )
FC_REFLECT(bvsio::chain::wait_weight, (wait_sec)(weight) )
FC_REFLECT(bvsio::chain::authority, (threshold)(keys)(accounts)(waits) )
FC_REFLECT(bvsio::chain::shared_authority, (threshold)(keys)(accounts)(waits) )
