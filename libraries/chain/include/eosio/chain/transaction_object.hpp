...
CHAINBASE_SET_INDEX_TYPE(bvsio::chain::transaction_object, bvsio::chain::transaction_multi_index)

FC_REFLECT(bvsio::chain::transaction_object, (expiration)(trx_id))
