...
#include <bvsio/chain/block_timestamp.hpp>
#include <bvsio/chain/abi_def.hpp>
...
namespace bvsio { namespace chain {
   ...
   class account_object : public chainbase::object<account_object_type, account_object> {
      ...
      void set_abi( const bvsio::chain::abi_def& a ) {
         abi.resize( fc::raw::pack_size( a ) );
         fc::datastream<char*> ds( abi.data(), abi.size() );
         fc::raw::pack( ds, a );
      }

      bvsio::chain::abi_def get_abi()const {
         bvsio::chain::abi_def a;
         BVS_ASSERT( abi.size() != 0, abi_not_found_exception, "No ABI set on account ${n}", ("n",name) );
...
CHAINBASE_SET_INDEX_TYPE(bvsio::chain::account_object, bvsio::chain::account_index)
CHAINBASE_SET_INDEX_TYPE(bvsio::chain::account_sequence_object, bvsio::chain::account_sequence_index)


FC_REFLECT(bvsio::chain::account_object, (name)(vm_type)(vm_version)(privileged)(last_code_update)(code_version)(creation_date)(code)(abi))
FC_REFLECT(bvsio::chain::account_sequence_object, (name)(recv_sequence)(auth_sequence)(code_sequence)(abi_sequence))