...
#include <bvsio/chain/incremental_merkle.hpp>
...
CHAINBASE_SET_INDEX_TYPE(bvsio::chain::global_property_object, bvsio::chain::global_property_multi_index)
CHAINBASE_SET_INDEX_TYPE(bvsio::chain::dynamic_global_property_object,
                         bvsio::chain::dynamic_global_property_multi_index)

FC_REFLECT(bvsio::chain::dynamic_global_property_object,
           (global_action_sequence)
          )

FC_REFLECT(bvsio::chain::global_property_object,
