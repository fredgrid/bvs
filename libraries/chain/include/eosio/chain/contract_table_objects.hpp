...
#include <bvsio/chain/multi_index_includes.hpp>
...
CHAINBASE_SET_INDEX_TYPE(bvsio::chain::table_id_object, bvsio::chain::table_id_multi_index)
CHAINBASE_SET_INDEX_TYPE(bvsio::chain::key_value_object, bvsio::chain::key_value_index)

CHAINBASE_SET_INDEX_TYPE(bvsio::chain::index64_object, bvsio::chain::index64_index)
CHAINBASE_SET_INDEX_TYPE(bvsio::chain::index128_object, bvsio::chain::index128_index)
CHAINBASE_SET_INDEX_TYPE(bvsio::chain::index256_object, bvsio::chain::index256_index)
CHAINBASE_SET_INDEX_TYPE(bvsio::chain::index_double_object, bvsio::chain::index_double_index)
CHAINBASE_SET_INDEX_TYPE(bvsio::chain::index_long_double_object, bvsio::chain::index_long_double_index)

FC_REFLECT(bvsio::chain::table_id_object, (code)(scope)(table)(payer)(count) )
FC_REFLECT(bvsio::chain::key_value_object, (primary_key)(payer)(value) )

#define REFLECT_SECONDARY(type)\
  FC_REFLECT(type, (primary_key)(payer)(secondary_key) )

REFLECT_SECONDARY(bvsio::chain::index64_object)
REFLECT_SECONDARY(bvsio::chain::index128_object)
REFLECT_SECONDARY(bvsio::chain::index256_object)
REFLECT_SECONDARY(bvsio::chain::index_double_object)
REFLECT_SECONDARY(bvsio::chain::index_long_double_object)
