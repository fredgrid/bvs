...
CHAINBASE_SET_INDEX_TYPE(bvsio::chain::permission_link_object, bvsio::chain::permission_link_index)

FC_REFLECT(bvsio::chain::permission_link_object, (account)(code)(message_type)(required_permission))
