...
CHAINBASE_SET_INDEX_TYPE( bvsio::public_key_history_object, bvsio::public_key_history_multi_index )

FC_REFLECT( bvsio::public_key_history_object, (public_key)(name)(permission) )
