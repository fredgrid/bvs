...
CHAINBASE_SET_INDEX_TYPE( bvsio::account_control_history_object, bvsio::account_control_history_multi_index )

FC_REFLECT( bvsio::account_control_history_object, (controlled_account)(controlled_permission)(controlling_account) )
