...
#include <bvsio/chain/action_receipt.hpp>
...
FC_REFLECT( bvsio::chain::account_delta,
            (account)(delta) )

FC_REFLECT( bvsio::chain::base_action_trace,
                    (receipt)(act)(context_free)(elapsed)(console)(trx_id)
                    (block_num)(block_time)(producer_block_id)(account_ram_deltas)(except) )

FC_REFLECT_DERIVED( bvsio::chain::action_trace,
                    (bvsio::chain::base_action_trace), (inline_traces) )

FC_REFLECT( bvsio::chain::transaction_trace, (id)(block_num)(block_time)(producer_block_id)
