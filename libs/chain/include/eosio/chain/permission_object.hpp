...
CHAINBASE_SET_INDEX_TYPE(bvsio::chain::permission_object, bvsio::chain::permission_index)
CHAINBASE_SET_INDEX_TYPE(bvsio::chain::permission_usage_object, bvsio::chain::permission_usage_index)

FC_REFLECT(bvsio::chain::permission_object, (usage_id)(parent)(owner)(name)(last_updated)(auth))
FC_REFLECT(bvsio::chain::snapshot_permission_object, (parent)(owner)(name)(last_updated)(last_used)(auth))

FC_REFLECT(bvsio::chain::permission_usage_object, (last_used))
