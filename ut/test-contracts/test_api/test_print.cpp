...
void test_print::test_printn() {
   printn(bvsio::name{"1"}.value);
   printn(bvsio::name{"5"}.value);
   printn(bvsio::name{"a"}.value);
   printn(bvsio::name{"z"}.value);

   printn(bvsio::name{"abc"}.value);
   printn(bvsio::name{"123"}.value);

   printn(bvsio::name{"abc.123"}.value);
   printn(bvsio::name{"123.abc"}.value);

   printn(bvsio::name{"12345abcdefgj"}.value);
   printn(bvsio::name{"ijklmnopqrstj"}.value);
   printn(bvsio::name{"vwxyz.12345aj"}.value);

   printn(bvsio::name{"111111111111j"}.value);
   printn(bvsio::name{"555555555555j"}.value);
   printn(bvsio::name{"aaaaaaaaaaaaj"}.value);
   printn(bvsio::name{"zzzzzzzzzzzzj"}.value);
}
